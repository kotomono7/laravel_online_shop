                        ...
                        <tbody>
                            @forelse ($items as $item)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="shopping-cart__product-price">Rp{{ number_format($item->price, 0, ',', '.') }}</span>
                                    </td>
                                    <td class="text-center">
                                        <div class="qty-control position-relative">
                                            <select style="padding: 5px;" id="change-qty"
                                    ...
                                    <td>
                                        <span
                                            class="shopping-cart__subtotal">Rp{{ number_format($item->price * $item->qty, 0, ',', '.') }}</span>
                                    </td>
                                    <td class="text-center">
                            ...
                            @empty
                                <tr>
                                    <td colspan="6">Tidak ada data di keranjang.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
                    ...
                    <div class="sticky-content">
                        ...
                        <div class="mobile_fixed-btn_wrapper">
                            <div class="button-wrapper container">
                                <a href="{{ url('orders/checkout') }}" class="btn btn-primary btn-checkout">CHECKOUT</a>
                            </div>
                        </div>
                    </div>
                </div>
