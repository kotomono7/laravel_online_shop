            ...
            <div id="accordion-filter-1" class="accordion-collapse collapse show border-0"
              ...
              <div class="accordion-body px-0 pb-0 pt-3">
                ...
                @foreach($categories as $category)
                  <li class="list-item">
                    <a href="{{ url('products?category='. $category->slug) }}" class="menu-link py-1">{{ $category->name }}</a>
                  </li>
                @endforeach
                </ul>
              </div>
              ...
              <div class="accordion-body px-0 pb-0">
                <div class="d-flex flex-wrap">
                        @foreach ($colors as $color)
                            <a href="{{ url('products?option='. $color->id) }}" class="swatch-size btn btn-sm btn-outline-light mb-3 me-3">{{ $color->name }}</a>
                        @endforeach
                        </div>
                    </div>
                    </div>
              ...
              <div class="accordion-body px-0 pb-0">
                <div class="d-flex flex-wrap">
                    @foreach ($sizes as $size)
                        <a href="{{ url('products?option='. $size->id) }}" class="swatch-size btn btn-sm btn-outline-light mb-3 me-3">{{ $size->name }}</a></li>
                    @endforeach
                </div>
              </div>
            </div>
