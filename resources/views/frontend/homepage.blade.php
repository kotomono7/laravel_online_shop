            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                ...
                <div class="text-center">
                  <a href="{{ url('products?category='. $category->slug) }}" class="menu-link fw-medium">{{ $category->name }}</a>
                </div>
              </div>
              @endforeach
            ...
            <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                ...
                @if ($product->productImages->first())
                    <img src="{{ asset('storage/'.$product->productImages->first()->path) }}" alt="{{ $product->name }}" loading="lazy" width="330" height="400"
              ...
              <div class="pc__info position-relative">
                ...
                <div class="product-card__price d-flex align-items-center">
                  <span class="money price text-secondary">Rp{{ number_format($product->priceLabel(),0, ",", ".") }}</span>
                </div>

                <div
                  class="anim_appear-bottom position-absolute bottom-0 start-0 d-none d-sm-flex align-items-center bg-body">
                  <a product-id="{{ $product->id }}" product-type="{{ $product->type }}" product-slug="{{ $product->slug }}" href="#" class="add-to-card btn-link btn-link_lg me-4 text-uppercase fw-medium"
