                                ...
                                <tbody>
                                    @forelse($orders as $order)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge"
                                                    @if ($order->payment_status === 'paid') style="background-color: #99e77d;" @else style="background-color:rgb(231, 125, 125);" @endif>{{ $order->payment_status }}</span>
                                            </td>
                                            <td>
                                                <a href="{{ url('orders/' . $order->id) }}" class="btn btn-info btn-sm">Lihat Detail</a>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
