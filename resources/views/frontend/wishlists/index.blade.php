                ...
                <div class="cart-table__wrapper">
                    <table class="cart-table">
                        ...
                        <tbody>
                                ...
                                <tr class="text-center">
                                    <td>
                                        <div class="shopping-cart__product-item">
                                            <img loading="lazy" src="{{ $image }}" width="120" height="120"
                                                alt="" />
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <span
                                            class="shopping-cart__product-price">{{ number_format($product->priceLabel(), 0, ',', '.') }}</span>
                                    </td>
                                    <td>
                                        <span class="shopping-cart__subtotal">Rp97.000.000</span>
                                    </td>
                                    <td>
                                        <a product-id="{{ $product->id }}" product-type="{{ $product->type }}"
                                            product-slug="{{ $product->slug }}" href="#"
                                            class="add-to-card btn btn-success text-uppercase fw-medium"
                                    ...
                                    <td>
                                        <form action="{{ route('wishlists.destroy', $wishlist->id) }}" method="post"
                                            ...
                                            @csrf
                                            @method('delete')
                                            <button type="submit" class="btn btn-danger text-white"><svg width="10"
                                                    height="10" viewBox="0 0 10 10" fill="#767676"
                            ...
                            @empty
                                <tr>
                                    <td colspan="4">Tidak ada data wishlist</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
