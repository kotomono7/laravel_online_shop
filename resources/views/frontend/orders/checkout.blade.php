                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating my-3">
                                    ...
                                    <label for="landmark">Alamat E-mail *</label>
                                    <span class="text-danger"></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating my-3">
                                    ...
                                    <label for="locality">Nomor Jalan</label>
                                    <span class="text-danger"></span>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mt-3 mb-3">
                                    ...
                                    <select class="form-control" name="province_id" style="appearance: auto !important;"
                            ...
                            <div class="col-md-4">
                                <div class="my-3">
                                    ...
                                    <select class="form-control" style="appearance: auto !important;"
                                        name="shipping_city_id" id="shipping-city">
                        ...
                        <div class="different-address">
                            ...
                            <div style="display:none;" id="ship-box-info">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-floating my-3">
                                            <input class="form-control" type="text" name="customer_first_name"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating my-3">
                                            <input class="form-control" type="text" name="customer_address1"
                                                value="{{ old('address1') }}">
                                            <label for="address">Alamat Rumah</label>
                                            <span class="text-danger"></span>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mt-3 mb-3">
                                            <label for="state">Provinsi *</label>
                                            <select class="form-control" style="appearance: auto !important;"
                                                name="customer_province_id" id="customer-shipping-province">
                                                <option value="">-- Pilih Provinsi --</option>
                                                @foreach ($provinces as $id => $province)
                                                    <option {{ auth()->user()->province_id == $id ? 'selected' : null }}
                                                        value="{{ $id }}">{{ $province }}</option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="my-3">
                                            <label for="city">Pilih Kota *</label>
                                            <select class="form-control" style="appearance: auto !important;"
                                                name="customer_shipping_city_id" id="customer_shipping_city">
                                                <option value="">-- Pilih Kota --</option>
                                                @if ($cities)
                                                    @foreach ($cities as $id => $city)
                                                        <option value="{{ $id }}">{{ $city }}</option>
                                ...
                                <table class="checkout-totals">
                                    <tbody>
                                        ...
                                        <tr class="cart-subtotal">
                                            <th>Biaya Pengiriman (gram)</th>
                                            <td><select class="form-control" style="appearance: auto !important;"
                                                    id="shipping-cost-option" required name="shipping_service">
                                                    <option value="">Pilih Kota Dulu</option>
                                                </select></td>
                                        </tr>
                                        <tr>
                                            <th>TOTAL</th>
                                            <td align="right">Rp<strong
                                                    class="total-amount">{{ Cart::subtotal(0, ',', '.') }}</strong></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
